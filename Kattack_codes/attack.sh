...
#diabetes todo
nohup python xgbKantchelianAttack.py -d=../chosen_sample/xgb/diabetes_xgb_samples.svm -m=../models/xgb/diabetes_xgb.model -c=2 >../Kattack_result/xgb/diabetes_xgb_log.txt 2>&1 &
#mnist todo
nohup python xgbKantchelianAttack.py -d=../chosen_sample/xgb/MNIST_xgb_samples.svm -m=../models/xgb/MNIST_xgb.model -c=10 >../Kattack_result/xgb/MNIST_xgb_log.txt 2>&1 &
...
nohup python xgbKantchelianAttack.py -d=../chosen_sample/rxgb/MNIST_rxgb_samples.s -m=../models/rxgb/MNIST_rxgb.model -c=10 >../Kattack_result/rxgb/MNIST_rxgb_log.txt 2>&1 &