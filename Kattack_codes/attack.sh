...
#nohup python xgbKantchelianAttack.py -d=../chosen_sample/xgb/MNIST2_6_xgb_samples.pkl -m=../models/xgb/MNIST2_6_xgb.model -c=10 >../Kattack_result/xgb/MNIST2_6_xgb_log.txt 2>&1 &
...
nohup python xgbKantchelianAttack.py -d=../chosen_sample/rxgb/covtype_rxgb_samples.s -m=../models/rxgb/covtype/covtype_rxgb.model -c=2 >../Kattack_result/rxgb/covtype_rxgb_log.txt 2>&1 &
