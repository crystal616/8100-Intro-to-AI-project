...
def main(args):
	...
	model = xgboost_wrapper(bst, binary=binary)#binary classification:  False

	if binary:
		attack = xgbKantchelianAttack(model, guard_val=args['guard_val'], round_digits=args['round_digits'])#temp file:  temporary1227.json,number of trees: 2000
	else:
